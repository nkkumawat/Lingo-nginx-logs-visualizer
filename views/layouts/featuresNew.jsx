            ...
            <div className="iconic-list">
              <div className="iconic-item wow fadeInUp" >
                ...
                <div className="iconic-content">
                  ...
                  <p className="fs-small">Instantly create understandable statistics from your logs. This offers the possibility of graphing and visualizing your data very easily.</p>
                </div>
              </div>
              <div className="iconic-item wow fadeInUp" >
              {/* style="visibility: visible; animation-name: fadeInUp;" */}
