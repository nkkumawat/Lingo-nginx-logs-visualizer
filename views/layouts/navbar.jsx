  ...
  if (props.uploadButton) {
    uploadButton = (
      <div className="ml-auto my-2 my-lg-0">
        ...
        <button className="btn btn-dark rounded-pill uploadButton">
          upload File
        </button>
      </div>
    );
          ...
          <ul className="navbar-nav ml-lg-5 mt-3 mt-lg-0">
            ...
            <li className="nav-item dropdown active">
              ...
              <div className="dropdown-menu" aria-labelledby="navbarDropdown">
                <a className="dropdown-item" href="/nginx">
                  Nginx Logs
                </a>
                <a className="dropdown-item" href="/nginx/route-vs-count">
                  Route vs Count
                </a>
                <a className="dropdown-item" href="/nginx/timeline">
                  Status Timeline
                </a>
              </div>
            </li>
