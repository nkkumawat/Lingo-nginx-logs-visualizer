        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-12 wow">
              <Filterlayout
                url={props.data2xx.data.url}
                fileName={props.data2xx.data.fileName}
              ></Filterlayout>
            </div>
            <div className="col-lg-12 wow">
              <ColumnChart
                data={props.data2xx.data}
                className="margin-left"
              ></ColumnChart>
            </div>
            <div className="col-lg-12 wow">
              <ColumnChart
                data={props.data3xx.data}
                className="margin-left"
              ></ColumnChart>
            </div>
            <div className="col-lg-12 wow">
              <ColumnChart
                data={props.data4xx.data}
                className="margin-left"
              ></ColumnChart>
            </div>
            <div className="col-lg-12 wow">
              <ColumnChart
                data={props.data5xx.data}
                className="margin-left"
              ></ColumnChart>
            </div>
          </div>
